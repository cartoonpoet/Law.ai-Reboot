import type { AdviceMessageKindTypes, AdviceRegionTypes, AdviceStatusTypes, SecurityLevel } from "@lawai/contracts";
...
export const ADVICE_STATUS_COLOR: Record<AdviceStatusTypes, "secondary" | "primary" | "warning" | "success" | "info"> = {
  received: "secondary",
  reviewing: "primary",
...
export const ADVICE_GROUPS: { value: AdviceGroupTypes; label: string; statuses: AdviceStatusTypes[] }[] = [
  ...
  { value: "received", label: "접수", statuses: ["received"] },
  { value: "reviewing", label: "검토", statuses: ["reviewing", "waitingRequester"] },
