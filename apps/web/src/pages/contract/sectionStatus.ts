...
export function deriveSectionStatus(v: ContractRequestForm): SectionStatus[] {
  const ov = [v.name, v.requester, v.party, v.categoryId, v.counterparties];
  ...
  return [
    { id: "overview", label: "계약 개요", requiredTotal: 5, requiredDone: ovDone, optional: false, status: statusOf(ovDone, 5, false) },
