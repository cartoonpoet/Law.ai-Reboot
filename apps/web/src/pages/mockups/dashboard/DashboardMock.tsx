      ...
      {isImproved ? (
        <Callout intent="info" title="현재 대시보드 기준 개선안">
          <ul className={css.changeList}>
            <li>뺀 것 — 상단 처리 대기·기한 임박 숫자(아래 탭·파이프라인과 중복), 검토 요청 버튼(사이드바에 있음), 할 일 검색창·페이지네이션(5건 목록엔 불필요)</li>
            <li>AI 보조 — AI 요약의 공통 버튼 3개를 항목별 바로 처리 버튼으로, 파이프라인 병목에 AI 분석, 할 일·계약·일정마다 AI 한 줄(왜 지금 · 준비된 것)</li>
