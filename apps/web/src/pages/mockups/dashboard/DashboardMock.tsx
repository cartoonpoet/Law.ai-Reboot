      ...
      {isImproved ? (
        <Callout intent="info" title="현재 대시보드 기준 개선안">
          <ul className={css.changeList}>
            <li>뺀 것 — 상단 숫자·검토 요청 버튼(사이드바와 중복), 진행 중 계약 탭, 할 일 검색창·페이지네이션</li>
            <li>파이프라인 — 지금 모양 그대로, 업무 종류 탭(계약·자문·송무·인감·지식재산, 배지 = 병목 수)만 추가. 기능이 늘면 탭만 추가</li>
            <li>AI 보조 — AI 요약은 항목별 바로 처리 버튼, 파이프라인 병목 분석, 할 일·일정마다 AI 한 줄(왜 지금 · 준비된 것)</li>
            <li>AI 비서 — 채널톡 스타일. 동그란 런처 + 먼저 말 거는 말풍선, 홈(새 대화·자주 시키는 일·최근 대화), 대화(빠른 답장·실행 전 확인)</li>
          </ul>
        </Callout>
      ) : (
