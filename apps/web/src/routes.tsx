        ...
        <Route
          ...
          element={
            <DocumentEditorMock
              ...
              description="지금 쓰는 서식 툴바(굵게·색·목록·정렬·링크) 오른쪽 끝에 표 넣기와 “로아이 도우미”를 나란히 붙였습니다. 아래 종이는 실제로 고쳐지는 편집 영역이고, 글을 끌어서 고르면 그 자리에 작은 버튼이 뜹니다. 글이 A4 한 장을 넘으면 워드처럼 다음 장으로 저절로 나뉘고, 툴바의 “페이지 나누기”를 넣은 자리에서도 쪽이 나뉩니다."
            />
          }
        />
        <Route
